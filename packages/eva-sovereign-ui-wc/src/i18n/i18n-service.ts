...
export class I18nService {
   ...
   * Five Eyes Countries Support:
   * - Canada: en-CA (English), fr-CA (French - mandatory)
   * - USA: en-US (English), es-US (Spanish)
   * - UK: en-GB (English), cy-GB (Welsh - Wales requirement)
   * - Australia: en-AU (English)
   * - New Zealand: en-NZ (English), mi-NZ (Te Reo Māori)
   */
  getAvailableLocales(): string[] {
    return [
      'en-CA', 'fr-CA',  // Canada
      'en-US', 'es-US',  // USA
      'en-GB', 'cy-GB',  // UK (Welsh for Wales)
      'en-AU',           // Australia
      'en-NZ', 'mi-NZ'   // New Zealand (Te Reo Māori)
    ];
  }
