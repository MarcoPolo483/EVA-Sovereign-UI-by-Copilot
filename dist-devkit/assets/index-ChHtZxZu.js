...
`);const T={canada_gc:{id:"canada_gc",name:"Government of Canada",nameFr:"Gouvernement du Canada",colors:{primary:"#26374A",secondary:"#284162",accent:"#A62A1E",text:"#333"},assets:{wordmark:"/assets/canada-wordmark.svg",logo:"/assets/canada-logo.svg",flag:"/assets/canada-flag.svg"},footer:{copyright:"© His Majesty the King in Right of Canada",links:[{label:"Privacy",url:"https://canada.ca/en/transparency/privacy"},{label:"Terms and conditions",url:"https://canada.ca/en/transparency/terms"},{label:"Accessibility",url:"https://canada.ca/en/accessibility"},{label:"Canada.ca",url:"https://canada.ca"}]},locale:{primary:"en-CA",secondary:"fr-CA"}},usa_gov:{id:"usa_gov",name:"U.S. Government",colors:{primary:"#002868",secondary:"#BF0A30",accent:"#FFFFFF",text:"#1b1b1b"},assets:{logo:"/assets/usa-seal.svg",flag:"/assets/usa-flag.svg",seal:"/assets/usa-seal.svg"},footer:{copyright:"An official website of the United States government",links:[{label:"Privacy Policy",url:"https://www.usa.gov/privacy"},{label:"Accessibility",url:"https://www.usa.gov/accessibility"},{label:"USA.gov",url:"https://www.usa.gov"}]},locale:{primary:"en-US"}},uk_gov:{id:"uk_gov",name:"UK Government",colors:{primary:"#012169",secondary:"#C8102E",accent:"#FFFFFF",text:"#0b0c0c"},assets:{logo:"/assets/uk-crown.svg",flag:"/assets/uk-flag.svg"},footer:{copyright:"© Crown copyright",links:[{label:"Privacy",url:"https://www.gov.uk/help/privacy-notice"},{label:"Cookies",url:"https://www.gov.uk/help/cookies"},{label:"Accessibility",url:"https://www.gov.uk/help/accessibility-statement"},{label:"GOV.UK",url:"https://www.gov.uk"}]},locale:{primary:"en-GB"}},australia_gov:{id:"australia_gov",name:"Australian Government",colors:{primary:"#00008B",secondary:"#FFCD00",accent:"#FF0000",text:"#313131"},assets:{logo:"/assets/australia-coat-of-arms.svg",flag:"/assets/australia-flag.svg"},footer:{copyright:"© Commonwealth of Australia",links:[{label:"Privacy",url:"https://www.australia.gov.au/privacy"},{label:"Accessibility",url:"https://www.australia.gov.au/accessibility"},{label:"Australia.gov.au",url:"https://www.australia.gov.au"}]},locale:{primary:"en-AU"}},nz_gov:{id:"nz_gov",name:"New Zealand Government",colors:{primary:"#00247D",secondary:"#CC142B",accent:"#FFFFFF",text:"#212121"},assets:{logo:"/assets/nz-fern.svg",flag:"/assets/nz-flag.svg"},footer:{copyright:"© New Zealand Government",links:[{label:"Privacy",url:"https://www.govt.nz/privacy"},{label:"Accessibility",url:"https://www.govt.nz/accessibility"},{label:"Govt.nz",url:"https://www.govt.nz"}]},locale:{primary:"en-NZ"}}};function L(l){return T[l]||T.canada_gc}class k{constructor(){this.currentLocale="en-CA",this.translations={},this.listeners=new Set}static getInstance(){return k.instance||(k.instance=new k),k.instance}async loadLocale(e){if(!this.translations[e])try{const i=await(await fetch(`/src/i18n/locales/${e}.json`)).json();this.translations[e]=i}catch(t){console.error(`Failed to load locale ${e}:`,t),this.translations[e]={}}}async setLocale(e){this.translations[e]||await this.loadLocale(e),this.currentLocale=e,this.notifyListeners()}getLocale(){return this.currentLocale}t(e,t){const i=e.split(".");let n=this.translations[this.currentLocale];for(const r of i)if(n&&typeof n=="object")n=n[r];else return e;return typeof n!="string"?e:t?n.replace(/\{(\w+)\}/g,(r,a)=>t[a]!==void 0?String(t[a]):`{${a}}`):n}subscribe(e){return this.listeners.add(e),()=>this.listeners.delete(e)}notifyListeners(){this.listeners.forEach(e=>e(this.currentLocale))}getAvailableLocales(){return["en-CA","fr-CA","en-US","es-US","en-GB","cy-GB","en-AU","en-NZ","mi-NZ"]}isLocaleLoaded(e){return!!this.translations[e]}}const E=k.getInstance();class c extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){this.unsubscribeI18n=E.subscribe(()=>{this.render()}),this.render()}disconnectedCallback(){this.unsubscribeI18n&&this.unsubscribeI18n()}render(){}t(e,t){return E.t(e,t)}getAttr(e,t=""){return this.getAttribute(e)||t}getBoolAttr(e){return this.hasAttribute(e)}createStyles(e){const t=document.createElement("style");return t.textContent=e,t}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}}class z extends c{static get observedAttributes(){return["profile","app-name-key","logo-url","flag-url"]}attributeChangedCallback(){this.render()}render(){const e=L(this.getAttr("profile","canada_gc")),t=this.getAttr("app-name-key","esdc.title"),i=this.t(t);this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
    ...
    `));const n=document.createElement("div");n.className="header-container",n.setAttribute("role","banner");const r=document.createElement("div");r.className="logo-section";const a=this.getAttr("logo-url")||e.assets.wordmark||e.assets.logo;if(a){const b=document.createElement("img");b.src=a,b.alt=e.name,b.className="wordmark",r.appendChild(b)}else{const b=document.createElement("div");b.className="logo-placeholder",b.textContent="GC",b.setAttribute("aria-hidden","true"),r.appendChild(b)}const d=this.getAttr("flag-url")||e.assets.flag;if(d){const b=document.createElement("img");b.src=d,b.alt=`${e.name} flag`,b.className="flag",r.appendChild(b)}const u=document.createElement("h1");u.className="app-title",u.textContent=i,r.appendChild(u),n.appendChild(r);const h=document.createElement("nav");h.className="actions-section",h.setAttribute("aria-label",this.t("header.navigation")||"Header navigation");const p=document.createElement("slot");p.name="actions",h.appendChild(p),n.appendChild(h),this.shadow.appendChild(n)}}customElements.define("eva-gc-header",z);class B extends c{static get observedAttributes(){return["profile"]}attributeChangedCallback(){this.render()}render(){const e=L(this.getAttr("profile","canada_gc"));this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: block;
        background: ${s.primary};
        color: ${s.primaryForeground};
    ...
    `));const t=document.createElement("div");t.className="footer-container",t.setAttribute("role","contentinfo");const i=document.createElement("p");i.className="copyright",i.textContent=e.footer.copyright,t.appendChild(i);const n=document.createElement("nav");n.setAttribute("aria-label","Footer navigation");const r=document.createElement("ul");r.className="links",e.footer.links.forEach(a=>{const d=document.createElement("li"),u=document.createElement("a");u.href=a.url,u.textContent=this.t(`footer.${a.label.toLowerCase().replace(/\s+/g,"")}`)||a.label,d.appendChild(u),r.appendChild(d)}),n.appendChild(r),t.appendChild(n),this.shadow.appendChild(t)}}customElements.define("eva-gc-footer",B);class D extends c{static get observedAttributes(){return["variant","size","disabled","loading","aria-label","profile"]}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","presentation"),super.connectedCallback()}attributeChangedCallback(){this.render()}render(){const e=this.getAttr("variant","default"),t=this.getAttr("size","default"),i=this.getBoolAttr("disabled"),n=this.getBoolAttr("loading"),a=L(this.getAttr("profile","canada_gc")).colors;this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
      ...
      button {
        ...
        &:focus-visible {
          outline: 3px solid ${a.primary};
          outline-offset: 3px;
          border-color: ${a.primary};
          box-shadow: 0 0 0 3px color-mix(in srgb, ${a.primary} 20%, transparent);
        }
      ...
      button.secondary:hover:not(:disabled) {
        background: ${A(a.secondary,20)};
      }

      /* Ghost variant - Transparent */
      button.ghost:hover:not(:disabled) {
        background: color-mix(in srgb, ${a.primary} 10%, transparent);
        color: ${a.primary};
      }
    ...
    `));const d=document.createElement("button");d.className=`${e} size-${t}`,d.disabled=i||n,d.setAttribute("type","button"),d.setAttribute("aria-disabled",i||n?"true":"false"),d.setAttribute("aria-busy",n?"true":"false");const u=this.getAttr("aria-label");if(u)d.setAttribute("aria-label",u),this.removeAttribute("aria-label");else{const v=(this.textContent||"").trim().length>0;t==="icon"&&!v&&d.setAttribute("aria-label",this.t("common.button"))}if(n){const v=document.createElement("span");v.className="spinner",v.setAttribute("role","status"),v.setAttribute("aria-label",this.t("accessibility.loading")),d.appendChild(v)}const h=document.createElement("slot");d.appendChild(h);const p=document.createElement("span"),b=()=>{const x=h.assignedNodes({flatten:!0}).map(w=>w.textContent||"").join("").trim();p.textContent=x};b(),h.addEventListener("slotchange",b),d.appendChild(p),this.shadow.appendChild(d)}}customElements.define("eva-gc-button",D);class H extends c{constructor(){super(...arguments),this.items=[],this.allowMultiple=!1}static get observedAttributes(){return["allow-multiple"]}connectedCallback(){super.connectedCallback(),this.allowMultiple=this.getBoolAttr("allow-multiple"),this.setupItems()}setupItems(){const e=this.querySelectorAll("eva-accordion-item");this.items=Array.from(e),this.items.forEach((t,i)=>{t.setAttribute("accordion-id",i.toString()),t.addEventListener("toggle",n=>{!this.allowMultiple&&n.detail.open&&this.items.forEach((r,a)=>{a!==i&&r.close()})})})}render(){this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: block;
        border-radius: ${o[2]};
      }
    ...
    `));const i=document.createElement("button");i.className="trigger",i.id=t,i.setAttribute("aria-expanded",this.isOpen.toString()),i.setAttribute("aria-controls",this.panelId),i.setAttribute("type","button"),i.setAttribute("role","button");const n=document.createElement("slot");n.name="trigger",i.appendChild(n);const r=document.createElement("span");r.className="chevron",r.textContent="▼",r.setAttribute("aria-hidden","true"),i.appendChild(r),this.shadow.appendChild(i);const a=document.createElement("div");a.className="content",a.id=this.panelId,a.setAttribute("data-state",this.isOpen?"open":"closed"),a.setAttribute("role","region"),a.setAttribute("aria-labelledby",t),this.isOpen?a.removeAttribute("hidden"):a.setAttribute("hidden",""),a.style.height=this.isOpen?"auto":"0";const d=document.createElement("div");d.className="content-inner";const u=document.createElement("slot");d.appendChild(u),a.appendChild(d),this.shadow.appendChild(a),this.contentEl=a,this.triggerEl=i,i.addEventListener("click",()=>this.toggle()),i.addEventListener("keydown",h=>{if((h.key==="Enter"||h.key===" ")&&(h.preventDefault(),this.toggle()),h.key==="ArrowDown"||h.key==="ArrowUp"){h.preventDefault();const p=this.parentElement;if(!p)return;const b=p.querySelectorAll("eva-accordion-item"),v=[];b.forEach(w=>{var I;const S=(I=w.shadowRoot)==null?void 0:I.querySelector(".trigger");S&&v.push(S)});const x=v.indexOf(i);if(x!==-1){const w=h.key==="ArrowDown"?x+1:x-1;v[w]&&v[w].focus()}}})}updateUI(){!this.triggerEl||!this.contentEl||(this.triggerEl.setAttribute("aria-expanded",this.isOpen.toString()),this.isOpen?(this.contentEl.setAttribute("data-state","open"),this.contentEl.removeAttribute("hidden"),this.contentEl.style.height="auto"):(this.contentEl.setAttribute("data-state","closed"),this.contentEl.setAttribute("hidden",""),this.contentEl.style.height="0"))}}customElements.define("eva-accordion",H);customElements.define("eva-accordion-item",V);class P extends c{static get observedAttributes(){return["variant"]}attributeChangedCallback(){this.render()}render(){const e=this.getAttr("variant","default");this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: block;
      }
    ...
    `));const t=document.createElement("div");t.className=`alert ${e}`,t.setAttribute("role","alert");const i=document.createElement("div");i.className="icon";const n=document.createElement("slot");n.name="icon",i.appendChild(n),t.appendChild(i);const r=document.createElement("div");r.className="content";const a=document.createElement("div");a.className="title";const d=document.createElement("slot");d.name="title",a.appendChild(d),r.appendChild(a);const u=document.createElement("div");u.className="description";const h=document.createElement("slot");u.appendChild(h),r.appendChild(u),t.appendChild(r),this.shadow.appendChild(t)}}customElements.define("eva-alert",P);class R extends c{constructor(){super(...arguments),this.isOpen=!1}static get observedAttributes(){return["open"]}attributeChangedCallback(){this.isOpen=this.getBoolAttr("open"),this.render(),this.isOpen?document.body.style.overflow="hidden":document.body.style.overflow=""}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",e=>{e.key==="Escape"&&this.isOpen&&this.close()})}close(){this.removeAttribute("open"),this.emit("close",{})}render(){if(this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
    ...
    `));const r=document.createElement("div");r.className="wrapper";const a=document.createElement("div");a.className="content";const d=document.createElement("slot");a.appendChild(d),r.appendChild(a),this.shadow.appendChild(r)}}customElements.define("eva-aspect-ratio",Y);class q extends c{render(){this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        position: relative;
        display: flex;
        width: 2rem;
    ...
    `));const e=document.createElement("img");e.className="image",e.src=this.getAttr("src",""),e.alt=this.getAttr("alt",""),e.addEventListener("error",()=>{this.style.display="none"}),this.shadow.appendChild(e)}}class U extends c{render(){this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: flex;
        width: 100%;
        height: 100%;
    ...
    `));const e=document.createElement("slot");this.shadow.appendChild(e)}}customElements.define("eva-avatar",q);customElements.define("eva-avatar-image",j);customElements.define("eva-avatar-fallback",U);class X extends c{static get observedAttributes(){return["variant"]}attributeChangedCallback(){this.render()}render(){const e=this.getAttr("variant","default");this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: inline-flex;
      }
    ...
    `));const t=document.createElement("span");t.className=`badge ${e}`,t.setAttribute("data-slot","badge");const i=document.createElement("slot");t.appendChild(i),this.shadow.appendChild(t)}}customElements.define("eva-badge",X);class G extends c{render(){this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: block;
      }
    ...
    `));const e=document.createElement("li");e.className="separator",e.setAttribute("role","presentation"),e.setAttribute("aria-hidden","true");const t=document.createElement("slot");e.appendChild(t),(i=this.textContent)!=null&&i.trim()||(e.textContent="›"),this.shadow.appendChild(e)}}customElements.define("eva-breadcrumb",G);customElements.define("eva-breadcrumb-list",K);customElements.define("eva-breadcrumb-item",W);customElements.define("eva-breadcrumb-link",_);customElements.define("eva-breadcrumb-page",Z);customElements.define("eva-breadcrumb-separator",J);class Q extends c{constructor(){super(...arguments),this.currentDate=new Date,this.selectedDate=null}static get observedAttributes(){return["value"]}attributeChangedCallback(){const e=this.getAttr("value","");e&&(this.selectedDate=new Date(e)),this.render()}previousMonth(){this.currentDate=new Date(this.currentDate.getFullYear(),this.currentDate.getMonth()-1,1),this.render()}nextMonth(){this.currentDate=new Date(this.currentDate.getFullYear(),this.currentDate.getMonth()+1,1),this.render()}selectDate(e){this.selectedDate=e,this.setAttribute("value",e.toISOString().split("T")[0]),this.emit("change",{date:e.toISOString()}),this.render()}handleDayKeydown(e,t){const i=t.getMonth()!==this.currentDate.getMonth();switch(e.key){case"ArrowLeft":i&&t<this.currentDate&&(this.previousMonth(),e.preventDefault());break;case"ArrowRight":i&&t>this.currentDate&&(this.nextMonth(),e.preventDefault());break;case"ArrowUp":t.getDate()<=7&&t.getMonth()!==this.currentDate.getMonth()&&(this.previousMonth(),e.preventDefault());break;case"ArrowDown":const n=new Date(t.getFullYear(),t.getMonth()+1,0).getDate();t.getDate()>n-7&&t.getMonth()!==this.currentDate.getMonth()&&(this.nextMonth(),e.preventDefault());break}}getDaysInMonth(){const e=this.currentDate.getFullYear(),t=this.currentDate.getMonth(),i=new Date(e,t,1),n=new Date(e,t+1,0),r=[],a=i.getDay();for(let d=a-1;d>=0;d--)r.push(new Date(e,t,-d));for(let d=1;d<=n.getDate();d++)r.push(new Date(e,t,d));return r}render(){this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: inline-block;
        padding: ${o[4]};
        background: ${s.background};
    ...
    `));const e=document.createElement("div"),t=document.createElement("div");t.className="header";const i=document.createElement("button");i.className="nav-button",i.textContent="‹",i.addEventListener("click",()=>this.previousMonth());const n=document.createElement("div");n.className="header-title",n.textContent=this.currentDate.toLocaleDateString("en-US",{month:"long",year:"numeric"});const r=document.createElement("button");r.className="nav-button",r.textContent="›",r.addEventListener("click",()=>this.nextMonth()),t.appendChild(i),t.appendChild(n),t.appendChild(r);const a=document.createElement("div");a.className="weekdays",["Su","Mo","Tu","We","Th","Fr","Sa"].forEach(h=>{const p=document.createElement("div");p.className="weekday",p.textContent=h,a.appendChild(p)});const d=document.createElement("div");d.className="days";const u=new Date;u.setHours(0,0,0,0),this.getDaysInMonth().forEach(h=>{const p=document.createElement("button");p.className="day",p.textContent=h.getDate().toString();const b=h.getMonth()!==this.currentDate.getMonth(),v=this.selectedDate&&h.getDate()===this.selectedDate.getDate()&&h.getMonth()===this.selectedDate.getMonth()&&h.getFullYear()===this.selectedDate.getFullYear(),x=h.getTime()===u.getTime();p.setAttribute("data-outside",b.toString()),p.setAttribute("data-selected",(!!v).toString()),p.setAttribute("data-today",x.toString()),p.addEventListener("click",()=>this.selectDate(h)),p.addEventListener("keydown",w=>this.handleDayKeydown(w,h)),d.appendChild(p)}),e.appendChild(t),e.appendChild(a),e.appendChild(d),this.shadow.appendChild(e)}}customElements.define("eva-calendar",Q);class ee extends c{render(){this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: block;
      }
    ...
    `));const e=document.createElement("div");e.className="content",e.setAttribute("data-slot","card-content");const t=document.createElement("slot");e.appendChild(t),this.shadow.appendChild(e)}}class re extends c{render(){this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: flex;
        align-items: center;
      }
    ...
    `));const e=document.createElement("div");e.className="carousel",e.setAttribute("aria-roledescription","carousel"),e.setAttribute("aria-label",this.getAttr("label","Carousel"));const t=document.createElement("div");t.className="items";const i=document.createElement("slot");t.appendChild(i);const n=document.createElement("button");n.className="nav-button prev",n.type="button",n.setAttribute("aria-label","Previous slide"),n.textContent="‹",n.addEventListener("click",()=>this.previous());const r=document.createElement("button");r.className="nav-button next",r.type="button",r.setAttribute("aria-label","Next slide"),r.textContent="›",r.addEventListener("click",()=>this.next());const a=document.createElement("div");a.className="indicators",this.liveRegion=document.createElement("div"),this.liveRegion.className="live-region",this.liveRegion.setAttribute("aria-live","polite"),e.appendChild(t),e.appendChild(n),e.appendChild(r),e.appendChild(a),e.appendChild(this.liveRegion),this.shadow.appendChild(e)}}class oe extends c{constructor(){super(...arguments),this.isActive=!1}static get observedAttributes(){return["active"]}attributeChangedCallback(){this.isActive=this.getBoolAttr("active"),this.render()}render(){this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
    ...
    `));const e=document.createElement("div");e.className="checkbox-wrapper",e.style.display="inline-flex",e.style.alignItems="center",e.style.gap=o[2];const t=document.createElement("input");t.type="checkbox",t.className="checkbox",t.checked=this.checked,t.disabled=this.getBoolAttr("disabled");const i=`chk-${Math.random().toString(36).slice(2)}`;t.id=i;const n=this.getAttr("name",""),r=this.getAttr("value","");n&&(t.name=n),r&&(t.value=r),e.appendChild(t);const a=document.createElement("div");a.className="visual",a.setAttribute("role","checkbox"),a.setAttribute("aria-checked",this.checked.toString()),a.setAttribute("tabindex","0"),a.addEventListener("click",()=>{this.getBoolAttr("disabled")||t.click()}),a.addEventListener("keydown",p=>{(p.key===" "||p.key==="Enter")&&(p.preventDefault(),t.click())});const d=document.createElement("div");d.className="indicator",d.innerHTML="✓",a.appendChild(d),e.appendChild(a);const u=this.getAttr("label",""),h=this.getAttr("aria-label","");if(u){this.labelId=this.labelId||`chk-label-${Math.random().toString(36).slice(2)}`;const p=document.createElement("label");p.id=this.labelId,p.htmlFor=i,p.textContent=u,p.style.fontSize="0.75rem",p.style.fontWeight="500",p.style.cursor="pointer",e.appendChild(p),a.setAttribute("aria-labelledby",this.labelId)}else a.removeAttribute("aria-labelledby"),h?(a.setAttribute("aria-label",h),t.setAttribute("aria-label",h)):(a.setAttribute("aria-label","Checkbox"),t.setAttribute("aria-label","Checkbox")),this.labelId=void 0;this.shadow.appendChild(e),this.inputEl=t,this.setupInput()}}customElements.define("eva-checkbox",le);class de extends c{constructor(){super(...arguments),this.isOpen=!1}static get observedAttributes(){return["open"]}attributeChangedCallback(){this.isOpen=this.getBoolAttr("open"),this.updateContent()}connectedCallback(){super.connectedCallback(),this.updateContent()}updateContent(){const e=this.querySelector("eva-collapsible-content");e&&(this.isOpen?e.setAttribute("open",""):e.removeAttribute("open"))}toggle(){this.isOpen=!this.isOpen,this.isOpen?this.setAttribute("open",""):this.removeAttribute("open"),this.emit("toggle",{open:this.isOpen})}render(){this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: block;
      }
    ...
    `));const e=document.createElement("div");e.className="trigger";const t=document.createElement("slot");t.name="trigger",e.appendChild(t);const i=document.createElement("div");i.className="menu",i.setAttribute("role","menu"),i.setAttribute("aria-orientation","vertical"),i.addEventListener("keydown",r=>this.handleMenuKeydown(r));const n=document.createElement("slot");i.appendChild(n),this.shadow.appendChild(e),this.shadow.appendChild(i),this.isOpen&&requestAnimationFrame(()=>requestAnimationFrame(()=>this.initializeRoving()))}getItemButtons(){return Array.from(this.querySelectorAll("eva-context-menu-item")).map(e=>{var t;return(t=e.shadowRoot)==null?void 0:t.querySelector("button.item")}).filter(Boolean)}initializeRoving(){const e=this.getItemButtons();e.forEach((t,i)=>t.setAttribute("tabindex",i===0?"0":"-1")),e[0]&&e[0].focus()}moveFocus(e){var r;const t=this.getItemButtons();if(!t.length)return;let i=t.findIndex(a=>a===document.activeElement);if(i===-1){const a=document.activeElement,d=(r=a==null?void 0:a.shadowRoot)==null?void 0:r.querySelector("button.item");d&&(i=t.findIndex(u=>u===d))}const n=i===-1?0:Math.min(Math.max(i+e,0),t.length-1);t.forEach((a,d)=>a.setAttribute("tabindex",d===n?"0":"-1")),t[n].focus()}handleMenuKeydown(e){var t;if(this.isOpen)switch(e.key){case"ArrowDown":case"Down":this.moveFocus(1),e.preventDefault();break;case"ArrowUp":case"Up":this.moveFocus(-1),e.preventDefault();break;case"Home":this.moveFocus(-9999),e.preventDefault();break;case"End":this.moveFocus(9999),e.preventDefault();break;case"Escape":this.isOpen=!1,this.render(),e.preventDefault();break;case"Enter":case" ":{let i=document.activeElement;if(i&&!i.classList.contains("item")){const n=(t=i.shadowRoot)==null?void 0:t.querySelector("button.item");n&&(i=n)}i&&i.classList.contains("item")&&(i.click(),e.preventDefault());break}}}}class pe extends c{render(){this.shadow.innerHTML="";const e=this.getAttr("variant","default");this.shadow.appendChild(this.createStyles(`
      :host {
        display: block;
      }
    ...
    `));const e=document.createElement("div");e.className="trigger";const t=document.createElement("slot");if(t.name="trigger",e.appendChild(t),this.shadow.appendChild(e),this.isOpen){const i=document.createElement("div");i.className="content",i.setAttribute("role","menu"),i.addEventListener("keydown",r=>this.handleMenuKeydown(r)),i.addEventListener("click",r=>{const a=r.target;(a.closest("eva-dropdown-menu-item")||a.classList.contains("item"))&&this.close()});const n=document.createElement("slot");i.appendChild(n),this.shadow.appendChild(i),this.contentEl=i,requestAnimationFrame(()=>{this.positionContent(),requestAnimationFrame(()=>this.initializeRovingItems())})}}getMenuItemButtons(){return Array.from(this.querySelectorAll("eva-dropdown-menu-item")).map(e=>{var t;return(t=e.shadowRoot)==null?void 0:t.querySelector(".item")}).filter(Boolean)}initializeRovingItems(){const e=this.getMenuItemButtons();e.forEach((t,i)=>{t.setAttribute("tabindex",i===0?"0":"-1"),t.setAttribute("role","menuitem")}),e[0]&&e[0].focus()}moveItemFocus(e){const t=this.getMenuItemButtons();if(!t.length)return;const i=t.findIndex(r=>r===document.activeElement),n=i===-1?0:Math.min(Math.max(i+e,0),t.length-1);t.forEach((r,a)=>r.setAttribute("tabindex",a===n?"0":"-1")),t[n].focus()}handleMenuKeydown(e){switch(e.key){case"ArrowDown":case"Down":this.moveItemFocus(1),e.preventDefault();break;case"ArrowUp":case"Up":this.moveItemFocus(-1),e.preventDefault();break;case"Home":this.moveItemFocus(-9999),e.preventDefault();break;case"End":this.moveItemFocus(9999),e.preventDefault();break;case"Escape":this.close(),e.preventDefault();break;case"Enter":case" ":{const t=document.activeElement;t&&t.classList.contains("item")&&(t.click(),e.preventDefault());break}}}}class xe extends c{static get observedAttributes(){return["variant","disabled"]}connectedCallback(){super.connectedCallback(),this.setupEventListeners()}setupEventListeners(){this.shadow.addEventListener("click",()=>{this.getBoolAttr("disabled")||this.emit("select",{})})}render(){const e=this.getAttr("variant","default");this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: block;
      }
    ...
    `));const e=document.createElement("div");e.style.display="flex",e.style.flexDirection="column",e.style.gap=o[1];const t=this.getAttr("label","");let i;t?(i=document.createElement("label"),this.labelId=this.labelId||`inp-label-${Math.random().toString(36).slice(2)}`,i.id=this.labelId,i.textContent=t,i.style.fontSize="0.75rem",i.style.fontWeight="500",i.style.color=s.mutedForeground,e.appendChild(i)):this.labelId=void 0;const n=document.createElement("input");n.className="input";const r=`inp-${Math.random().toString(36).slice(2)}`;if(n.id=r,n.type=this.getAttr("type","text"),n.value=this.getAttr("value",""),n.placeholder=this.getAttr("placeholder",""),n.disabled=this.getBoolAttr("disabled"),n.readOnly=this.getBoolAttr("readonly"),i)i.htmlFor=r,n.setAttribute("aria-labelledby",this.labelId);else{const d=this.getAttr("aria-label","");d?n.setAttribute("aria-label",d):n.setAttribute("aria-label","Input")}const a=this.getAttr("error","");if(a?(this.errorId=this.errorId||`inp-err-${Math.random().toString(36).slice(2)}`,n.setAttribute("aria-describedby",this.errorId),n.setAttribute("aria-invalid","true")):this.errorId=void 0,e.appendChild(n),a){const d=document.createElement("div");d.id=this.errorId,d.textContent=a,d.style.fontSize="0.75rem",d.style.color=s.destructive,e.appendChild(d)}this.shadow.appendChild(e),this.inputEl=n,this.setupInput()}}customElements.define("eva-input",Ae);class $e extends c{constructor(){super(...arguments),this.inputs=[],this.maxLength=6}static get observedAttributes(){return["max-length","value"]}attributeChangedCallback(){this.maxLength=parseInt(this.getAttr("max-length","6"),10),this.render()}handleInput(e,t){var r;t.target.value&&e<this.maxLength-1&&((r=this.inputs[e+1])==null||r.focus()),this.emitValue()}handleKeyDown(e,t){var n,r,a;const i=t.target;t.key==="Backspace"&&!i.value&&e>0?(n=this.inputs[e-1])==null||n.focus():t.key==="ArrowLeft"&&e>0?(r=this.inputs[e-1])==null||r.focus():t.key==="ArrowRight"&&e<this.maxLength-1&&((a=this.inputs[e+1])==null||a.focus())}handlePaste(e){var r,a;e.preventDefault();const i=(((r=e.clipboardData)==null?void 0:r.getData("text"))||"").split("").slice(0,this.maxLength);i.forEach((d,u)=>{this.inputs[u]&&(this.inputs[u].value=d)});const n=Math.min(i.length,this.maxLength-1);(a=this.inputs[n])==null||a.focus(),this.emitValue()}emitValue(){const e=this.inputs.map(t=>t.value).join("");this.emit("change",{value:e})}render(){this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: inline-flex;
        gap: ${o[2]};
      }
    ...
    `));const e=document.createElement("div");e.style.display="contents",this.inputs=[];const t=this.getAttr("aria-label","One-time passcode");for(let i=0;i<this.maxLength;i++){const n=document.createElement("input");n.className="input",n.type="text",n.inputMode="numeric",n.maxLength=1,n.pattern="[0-9]",n.setAttribute("aria-label",`${t} ${i+1}/${this.maxLength}`),this.getBoolAttr("disabled")&&(n.disabled=!0),n.addEventListener("input",r=>this.handleInput(i,r)),n.addEventListener("keydown",r=>this.handleKeyDown(i,r)),i===0&&n.addEventListener("paste",r=>this.handlePaste(r)),this.inputs.push(n),e.appendChild(n)}this.shadow.appendChild(e)}}customElements.define("eva-input-otp",$e);class Le extends c{static get observedAttributes(){return["for"]}connectedCallback(){super.connectedCallback();const e=this.getAttr("for","");e&&this.addEventListener("click",()=>{var i;const t=document.getElementById(e);t&&(t.focus(),(i=t.click)==null||i.call(t))})}render(){this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: inline-flex;
      }
    ...
    `));const e=document.createElement("div");e.className="menubar",e.setAttribute("role","menubar"),e.addEventListener("keydown",i=>this.handleMenubarKeydown(i));const t=document.createElement("slot");t.addEventListener("slotchange",()=>this.initializeMenubarRoving()),e.appendChild(t),this.shadow.appendChild(e),requestAnimationFrame(()=>this.initializeMenubarRoving())}getMenuTriggers(){return Array.from(this.querySelectorAll("eva-menubar-menu")).map(e=>{var t;return(t=e.shadowRoot)==null?void 0:t.querySelector("button.trigger")}).filter(Boolean)}initializeMenubarRoving(){const e=this.getMenuTriggers();e.length&&e.forEach((t,i)=>{t.setAttribute("tabindex",i===0?"0":"-1"),t.setAttribute("role","menuitem")})}moveMenubarFocus(e){const t=this.getMenuTriggers();if(!t.length)return;const i=t.findIndex(r=>r===document.activeElement);let n=i===-1?0:i+e;n<0&&(n=t.length-1),n>=t.length&&(n=0),t.forEach((r,a)=>r.setAttribute("tabindex",a===n?"0":"-1")),t[n].focus()}handleMenubarKeydown(e){var t,i;switch(e.key){case"ArrowRight":case"Right":this.moveMenubarFocus(1),e.preventDefault();break;case"ArrowLeft":case"Left":this.moveMenubarFocus(-1),e.preventDefault();break;case"Home":this.moveMenubarFocus(-9999),e.preventDefault();break;case"End":this.moveMenubarFocus(9999),e.preventDefault();break;case"Enter":case" ":{const n=document.activeElement;n&&n.classList.contains("trigger")&&(n.click(),e.preventDefault());break}case"ArrowDown":case"Down":{const n=Array.from(this.querySelectorAll("eva-menubar-menu")).find(r=>{var a,d;return((d=(a=r.shadowRoot)==null?void 0:a.querySelector("button.trigger"))==null?void 0:d.getAttribute("data-open"))==="true"});if(n){const r=(t=n.shadowRoot)!=null&&t.querySelector("div.content slot")?n.querySelector("eva-menubar-item"):null,a=(i=r==null?void 0:r.shadowRoot)==null?void 0:i.querySelector("button.item");a&&(a.focus(),e.preventDefault())}break}}}}class Ie extends c{constructor(){super(...arguments),this.isOpen=!1}connectedCallback(){super.connectedCallback(),document.addEventListener("click",e=>{!this.contains(e.target)&&this.isOpen&&(this.isOpen=!1,this.render())})}toggle(){this.isOpen=!this.isOpen,this.render()}render(){this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        position: relative;
        display: inline-flex;
      }
    ...
    `));const t=document.createElement("button");t.className="item",this.getBoolAttr("disabled")&&(t.disabled=!0);const i=document.createElement("slot");t.appendChild(i),this.shadow.appendChild(t)}}customElements.define("eva-menubar",Se);customElements.define("eva-menubar-menu",Ie);customElements.define("eva-menubar-item",Te);class Me extends c{constructor(){super(...arguments),this.currentPage=1,this.totalPages=1}static get observedAttributes(){return["current","total"]}attributeChangedCallback(){this.currentPage=parseInt(this.getAttr("current","1"),10),this.totalPages=parseInt(this.getAttr("total","1"),10),this.render()}handlePageClick(e){e<1||e>this.totalPages||(this.currentPage=e,this.setAttribute("current",e.toString()),this.emit("change",{page:e}),this.updateAriaCurrent())}getPageNumbers(){const e=[];if(this.totalPages<=7){for(let n=1;n<=this.totalPages;n++)e.push(n);return e}e.push(1),this.currentPage>3&&e.push("ellipsis");const t=Math.max(2,this.currentPage-1),i=Math.min(this.totalPages-1,this.currentPage+1);for(let n=t;n<=i;n++)e.push(n);return this.currentPage<this.totalPages-2&&e.push("ellipsis"),e.push(this.totalPages),e}render(){this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: inline-flex;
        align-items: center;
        gap: ${o[2]};
    ...
    `));const e=document.createElement("nav");e.setAttribute("aria-label","Pagination"),e.setAttribute("role","navigation"),e.style.display="inline-flex",e.style.gap=o[2],e.addEventListener("keydown",a=>this.handleKeydown(a));const t=document.createElement("div");t.style.display="contents";const i=document.createElement("button");i.className="button",i.textContent="‹",i.disabled=this.currentPage===1,i.addEventListener("click",()=>this.handlePageClick(this.currentPage-1)),t.appendChild(i),this.getPageNumbers().forEach(a=>{if(a==="ellipsis"){const d=document.createElement("span");d.className="ellipsis",d.textContent="...",t.appendChild(d)}else{const d=document.createElement("button");d.className="button",d.textContent=a.toString(),d.setAttribute("aria-label",`Go to page ${a}`),d.setAttribute("data-active",(a===this.currentPage).toString()),a===this.currentPage?(d.setAttribute("aria-current","page"),d.setAttribute("tabindex","0")):d.setAttribute("tabindex","-1"),d.addEventListener("click",()=>this.handlePageClick(a)),t.appendChild(d)}});const r=document.createElement("button");r.className="button",r.textContent="›",r.disabled=this.currentPage===this.totalPages,r.addEventListener("click",()=>this.handlePageClick(this.currentPage+1)),t.appendChild(r),e.appendChild(t),this.shadow.appendChild(e)}updateAriaCurrent(){this.shadow.querySelectorAll(".button").forEach(t=>{t.removeAttribute("aria-current"),parseInt(t.textContent||"0",10)===this.currentPage?(t.setAttribute("aria-current","page"),t.setAttribute("data-active","true"),t.setAttribute("tabindex","0")):(t.setAttribute("data-active","false"),t.setAttribute("tabindex","-1"))})}handleKeydown(e){const t=Array.from(this.shadow.querySelectorAll(".button")).filter(r=>!isNaN(parseInt(r.textContent||"",10)));if(!t.length)return;const i=t.findIndex(r=>parseInt(r.textContent||"0",10)===this.currentPage);if(i===-1)return;let n=i;switch(e.key){case"ArrowRight":case"Right":n=Math.min(t.length-1,i+1),e.preventDefault();break;case"ArrowLeft":case"Left":n=Math.max(0,i-1),e.preventDefault();break;case"Home":n=0,e.preventDefault();break;case"End":n=t.length-1,e.preventDefault();break;case"Enter":case" ":if(document.activeElement&&document.activeElement.classList.contains("button")){const r=parseInt(document.activeElement.textContent||"0",10);isNaN(r)||this.handlePageClick(r)}e.preventDefault();return;default:return}n!==i&&(t.forEach((r,a)=>r.setAttribute("tabindex",a===n?"0":"-1")),t[n].focus())}}customElements.define("eva-pagination",Me);class Oe extends c{constructor(){super(...arguments),this.isOpen=!1,this.handleOutsideClick=e=>{this.contains(e.target)||this.close()}}static get observedAttributes(){return["open"]}attributeChangedCallback(){this.isOpen=this.getBoolAttr("open"),this.render(),this.isOpen?(this.positionContent(),document.addEventListener("click",this.handleOutsideClick)):document.removeEventListener("click",this.handleOutsideClick)}connectedCallback(){super.connectedCallback(),this.setupTrigger()}disconnectedCallback(){document.removeEventListener("click",this.handleOutsideClick)}setupTrigger(){const e=this.querySelector('[slot="trigger"]');e&&(this.triggerEl=e,e.addEventListener("click",t=>{t.stopPropagation(),this.toggle()}))}positionContent(){!this.contentEl||!this.triggerEl||requestAnimationFrame(()=>{const e=this.triggerEl.getBoundingClientRect(),t=this.contentEl.getBoundingClientRect();let i=e.bottom+4,n=e.left;i+t.height>window.innerHeight&&(i=e.top-t.height-4),n+t.width>window.innerWidth&&(n=window.innerWidth-t.width-8),this.contentEl.style.top=`${i}px`,this.contentEl.style.left=`${n}px`})}open(){this.setAttribute("open","")}close(){this.removeAttribute("open")}toggle(){this.isOpen?this.close():this.open()}render(){this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: inline-block;
        position: relative;
      }
    ...
    `));const r=document.createElement("div");r.className="progress",r.setAttribute("role","progressbar"),r.setAttribute("aria-valuemin","0"),r.setAttribute("aria-valuemax",t.toString()),r.setAttribute("aria-valuenow",e.toString()),r.setAttribute("aria-live","polite"),r.setAttribute("aria-atomic","true"),n?r.setAttribute("aria-label",n):r.setAttribute("aria-label",`${Math.round(i)}% complete`);const a=document.createElement("div");a.className="indicator",r.appendChild(a),this.shadow.appendChild(r)}}customElements.define("eva-progress",Fe);class Ne extends c{constructor(){super(...arguments),this.value=""}static get observedAttributes(){return["value","name"]}attributeChangedCallback(){this.value=this.getAttr("value",""),this.updateItems()}connectedCallback(){super.connectedCallback(),this.setupItems(),this.updateItems()}setupItems(){this.addEventListener("radio-select",e=>{this.value=e.detail.value,this.setAttribute("value",this.value),this.emit("change",{value:this.value}),this.updateItems()})}updateItems(){this.querySelectorAll("eva-radio-group-item").forEach(t=>{(t.getAttribute("value")||"")===this.value?t.setAttribute("checked",""):t.removeAttribute("checked")})}render(){this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: grid;
        gap: ${o[3]};
      }
    ...
    `));const e=document.createElement("div");e.className="radio-wrapper";const t=this.closest("eva-radio-group"),i=(t==null?void 0:t.getAttribute("name"))||"radio-group",n=document.createElement("input");n.type="radio",n.className="radio",n.name=i,n.checked=this.checked,n.disabled=this.getBoolAttr("disabled");const r=this.getAttr("value","");r&&(n.value=r),e.appendChild(n);const a=document.createElement("div");a.className="visual",a.setAttribute("role","radio"),a.setAttribute("aria-checked",this.checked.toString()),a.setAttribute("tabindex","0"),a.addEventListener("click",()=>{this.getBoolAttr("disabled")||n.click()}),a.addEventListener("keydown",h=>{(h.key===" "||h.key==="Enter")&&!this.getBoolAttr("disabled")&&(h.preventDefault(),n.click())});const d=document.createElement("div");d.className="indicator";const u=document.createElement("div");u.className="indicator-dot",d.appendChild(u),a.appendChild(d),e.appendChild(a),this.shadow.appendChild(e),this.inputEl=n,this.setupInput()}}customElements.define("eva-radio-group",Ne);customElements.define("eva-radio-group-item",ze);class Be extends c{render(){this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: block;
        position: relative;
        overflow: hidden;
    ...
    `)),!this.isOpen)return;const t=document.createElement("div");t.className="overlay",t.addEventListener("click",()=>this.close()),this.shadow.appendChild(t);const i=document.createElement("div");i.className="content",i.addEventListener("click",d=>d.stopPropagation());const n=document.createElement("slot");i.appendChild(n);const r=document.createElement("button");r.className="close-button",r.setAttribute("type","button"),r.innerHTML="✕",r.addEventListener("click",()=>this.close());const a=document.createElement("span");a.className="sr-only",a.textContent="Close",r.appendChild(a),i.appendChild(r),this.shadow.appendChild(i)}}class Re extends c{render(){this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: flex;
        flex-direction: column;
        gap: ${o[2]};
    ...
    `));const e=document.createElement("slot");this.shadow.appendChild(e)}}customElements.define("eva-sheet",Pe);customElements.define("eva-sheet-header",Re);customElements.define("eva-sheet-footer",Ye);customElements.define("eva-sheet-title",qe);customElements.define("eva-sheet-description",je);class Ue extends c{static get observedAttributes(){return["variant","width","height","lines","circle"]}connectedCallback(){super.connectedCallback(),this.render()}render(){const e=this.getAttribute("variant")||"text",t=this.getAttribute("width")||"100%",i=this.getAttribute("height")||"1em",n=parseInt(this.getAttribute("lines")||"1"),r=this.hasAttribute("circle"),a=this.createStyles(`
      :host {
        display: block;
      }
    ...
    `);this.shadow.innerHTML="",this.shadow.appendChild(a);const d=document.createElement("div");d.setAttribute("role","status"),d.setAttribute("aria-busy","true");const u=document.createElement("span");if(u.textContent="Loading",u.className="sr-only",d.appendChild(u),r||e==="circle"){const h=document.createElement("div");h.className="skeleton skeleton-circle",h.style.width=t,h.style.height=i,d.appendChild(h)}else if(e==="text")for(let h=0;h<n;h++){const p=document.createElement("div");p.className="skeleton skeleton-text",p.style.width=h===n-1?"80%":t,p.style.height=i,d.appendChild(p)}else{const h=document.createElement("div");h.className="skeleton skeleton-rectangle",h.style.width=t,h.style.height=i,d.appendChild(h)}this.shadow.appendChild(d)}}customElements.define("eva-skeleton",Ue);class Xe extends c{constructor(){super(...arguments),this.value=50,this.min=0,this.max=100,this.step=1}static get observedAttributes(){return["value","min","max","step","disabled","aria-label"]}attributeChangedCallback(){this.value=parseFloat(this.getAttr("value","50")),this.min=parseFloat(this.getAttr("min","0")),this.max=parseFloat(this.getAttr("max","100")),this.step=parseFloat(this.getAttr("step","1")),this.inputEl?(this.inputEl.value=this.value.toString(),this.inputEl.min=this.min.toString(),this.inputEl.max=this.max.toString(),this.inputEl.step=this.step.toString(),this.inputEl.disabled=this.getBoolAttr("disabled"),this.updateVisuals()):this.render()}connectedCallback(){super.connectedCallback(),this.setupInput()}setupInput(){this.inputEl&&(this.inputEl.addEventListener("input",e=>{const t=e.target;this.value=parseFloat(t.value),this.setAttribute("value",this.value.toString()),this.emit("input",{value:this.value}),this.updateVisuals()}),this.inputEl.addEventListener("change",e=>{const t=e.target;this.emit("change",{value:parseFloat(t.value)})}))}updateVisuals(){const e=this.getPercentage();this.rangeEl&&(this.rangeEl.style.width=`${e}%`),this.thumbEl&&(this.thumbEl.style.left=`calc(${e}% - 10px)`),this.inputEl&&this.inputEl.setAttribute("aria-valuenow",this.value.toString())}getPercentage(){return(this.value-this.min)/(this.max-this.min)*100}render(){this.shadow.innerHTML="";const e=this.getPercentage();this.shadow.appendChild(this.createStyles(`
      :host {
        display: block;
        width: 100%;
      }
      ...
      .slider:hover:not(:disabled) ~ .thumb {
        box-shadow: 0 0 0 6px color-mix(in srgb, ${s.ring} 40%, transparent);
        transform: translateY(-50%) scale(1.1);
      }

      .slider:focus-visible ~ .thumb {
        outline: none;
        box-shadow: 0 0 0 6px color-mix(in srgb, ${s.ring} 50%, transparent);
        transform: translateY(-50%) scale(1.15);
      }
      
      .slider:active:not(:disabled) ~ .thumb {
        transform: translateY(-50%) scale(1.2);
        box-shadow: 0 0 0 8px color-mix(in srgb, ${s.ring} 30%, transparent);
      }
    ...
    `));const t=document.createElement("div");t.className="slider-wrapper";const i=document.createElement("input");i.type="range",i.className="slider",i.value=this.value.toString(),i.min=this.min.toString(),i.max=this.max.toString(),i.step=this.step.toString(),i.disabled=this.getBoolAttr("disabled"),i.setAttribute("aria-valuemin",this.min.toString()),i.setAttribute("aria-valuemax",this.max.toString()),i.setAttribute("aria-valuenow",this.value.toString());const n=this.getAttr("aria-label","");n?i.setAttribute("aria-label",n):i.setAttribute("aria-label","Slider"),t.appendChild(i);const r=document.createElement("div");r.className="track";const a=document.createElement("div");a.className="range",r.appendChild(a),t.appendChild(r);const d=document.createElement("div");d.className="thumb",t.appendChild(d),this.shadow.appendChild(t),this.inputEl=i,this.rangeEl=a,this.thumbEl=d,this.setupInput()}}customElements.define("eva-slider",Xe);class Ge extends c{constructor(){super(...arguments),this.checked=!1}static get observedAttributes(){return["checked","disabled","value","name","aria-label"]}attributeChangedCallback(){this.checked=this.getBoolAttr("checked"),this.render(),this.inputEl&&(this.inputEl.checked=this.checked,this.inputEl.disabled=this.getBoolAttr("disabled"))}connectedCallback(){super.connectedCallback(),this.setupInput()}setupInput(){this.inputEl&&this.inputEl.addEventListener("change",e=>{const t=e.target;this.checked=t.checked,this.checked?this.setAttribute("checked",""):this.removeAttribute("checked"),this.emit("change",{checked:this.checked}),this.render()})}render(){this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: inline-flex;
      }
    ...
    `));const e=document.createElement("div");e.className="switch-wrapper";const t=document.createElement("input");t.type="checkbox",t.className="switch",t.checked=this.checked,t.disabled=this.getBoolAttr("disabled"),t.setAttribute("role","switch"),t.setAttribute("aria-checked",this.checked.toString());const i=this.getAttr("aria-label","");i?t.setAttribute("aria-label",i):t.setAttribute("aria-label","Switch");const n=this.getAttr("name",""),r=this.getAttr("value","");n&&(t.name=n),r&&(t.value=r),e.appendChild(t);const a=document.createElement("div");a.className="visual",a.setAttribute("tabindex","0"),a.addEventListener("click",()=>{this.getBoolAttr("disabled")||t.click()}),a.addEventListener("keydown",u=>{(u.key===" "||u.key==="Enter")&&(u.preventDefault(),t.click())});const d=document.createElement("div");d.className="thumb",a.appendChild(d),e.appendChild(a),this.shadow.appendChild(e),this.inputEl=t,this.setupInput()}}customElements.define("eva-switch",Ge);class Ke extends c{render(){this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: block;
        width: 100%;
        overflow: auto;
    ...
    `));const e=document.createElement("div");e.style.display="flex",e.style.flexDirection="column",e.style.gap=o[1];const t=this.getAttr("label","");let i;t?(i=document.createElement("label"),this.labelId=this.labelId||`txt-label-${Math.random().toString(36).slice(2)}`,i.id=this.labelId,i.textContent=t,i.style.fontSize="0.75rem",i.style.fontWeight="500",i.style.color=s.mutedForeground,e.appendChild(i)):this.labelId=void 0;const n=document.createElement("textarea");n.className="textarea";const r=`txt-${Math.random().toString(36).slice(2)}`;if(n.id=r,n.value=this.getAttr("value",""),n.placeholder=this.getAttr("placeholder",""),n.rows=parseInt(this.getAttr("rows","4")),n.disabled=this.getBoolAttr("disabled"),n.readOnly=this.getBoolAttr("readonly"),i)i.htmlFor=r,n.setAttribute("aria-labelledby",this.labelId);else{const a=this.getAttr("aria-label","");a?n.setAttribute("aria-label",a):n.setAttribute("aria-label","Textarea")}e.appendChild(n),this.shadow.appendChild(e),this.textareaEl=n,this.setupTextarea()}}customElements.define("eva-textarea",nt);class rt extends c{constructor(){super(...arguments),this.pressed=!1}static get observedAttributes(){return["variant","size","disabled","aria-label"]}attributeChangedCallback(e){(e==="variant"||e==="size"||e==="disabled"||e==="aria-label")&&this.render()}connectedCallback(){super.connectedCallback()}handlePress(){if(this.getBoolAttr("disabled"))return;this.pressed=!this.pressed,this.pressed?this.setAttribute("pressed",""):this.removeAttribute("pressed");const e=this.shadow.querySelector(".toggle");e&&(e.setAttribute("data-pressed",this.pressed.toString()),e.setAttribute("aria-pressed",this.pressed.toString())),this.emit("toggle",{pressed:this.pressed})}render(){const e=this.getAttr("variant","default"),t=this.getAttr("size","default"),i={sm:"2rem",default:"2.25rem",lg:"2.5rem"},n={sm:"2rem",default:"2.25rem",lg:"2.5rem"},r={sm:o[2],default:o[2],lg:o[3]};this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: inline-flex;
      }
    ...
    `));const a=document.createElement("button");a.className="toggle",a.type="button",a.setAttribute("data-variant",e),a.setAttribute("data-pressed",this.pressed.toString()),a.setAttribute("aria-pressed",this.pressed.toString());const d=this.getAttr("aria-label","");d?a.setAttribute("aria-label",d):a.setAttribute("aria-label","Toggle"),a.addEventListener("click",()=>this.handlePress()),a.addEventListener("keydown",h=>{(h.key===" "||h.key==="Enter")&&(h.preventDefault(),this.handlePress())}),this.getBoolAttr("disabled")&&(a.disabled=!0);const u=document.createElement("slot");a.appendChild(u),this.shadow.appendChild(a)}}customElements.define("eva-toggle",rt);class at extends c{constructor(){super(...arguments),this.value="",this.type="single"}static get observedAttributes(){return["value","type"]}attributeChangedCallback(){this.value=this.getAttr("value",""),this.type=this.getAttr("type","single")}connectedCallback(){super.connectedCallback(),this.addEventListener("toggle-item",e=>{this.type==="single"&&(this.value=e.detail.value,this.setAttribute("value",this.value),this.updateItems()),this.emit("change",{value:this.value})})}updateItems(){this.querySelectorAll("eva-toggle-group-item").forEach(t=>{(t.getAttribute("value")||"")===this.value?t.setAttribute("pressed",""):t.removeAttribute("pressed")})}render(){this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: inline-flex;
        border-radius: ${o[2]};
        background: ${s.muted};
    ...
    `));const e=document.createElement("header"),t=document.createElement("slot");t.name="header",e.appendChild(t),this.shadow.appendChild(e);const i=document.createElement("main");i.id="main-content",i.setAttribute("role","main"),i.setAttribute("tabindex","-1");const n=document.createElement("slot");i.appendChild(n),this.shadow.appendChild(i);const r=document.createElement("footer"),a=document.createElement("slot");a.name="footer",r.appendChild(a),this.shadow.appendChild(r)}}customElements.define("eva-page-shell",dt);class ct extends c{static get observedAttributes(){return["title-key","description-key","background"]}attributeChangedCallback(){this.render()}render(){const e=this.getAttr("title-key","esdc.hero.title"),t=this.getAttr("description-key","esdc.hero.description"),i=this.getAttr("background",s.primary),n=this.t(e),r=this.t(t);this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: block;
        background: ${i};
    ...
    `));const a=document.createElement("div");a.className="hero-container";const d=document.createElement("h1");d.className="hero-title",d.textContent=n,a.appendChild(d);const u=document.createElement("p");u.className="hero-description",u.textContent=r,a.appendChild(u),this.shadow.appendChild(a)}}customElements.define("eva-hero-banner",ct);class ht extends c{static get observedAttributes(){return["max-width"]}attributeChangedCallback(){this.render()}render(){const e=this.getAttr("max-width",F.contentMaxWidth);this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: block;
        width: 100%;
      }
...
• Benefits programs`}renderMessages(){this.messageContainer&&(this.messageContainer.innerHTML="",this.messages.forEach(e=>{const t=document.createElement("eva-chat-message");t.setAttribute("type",e.type),t.setAttribute("timestamp",e.timestamp.toISOString()),t.textContent=e.content,this.messageContainer.appendChild(t)}),this.messageContainer.scrollTop=this.messageContainer.scrollHeight,this.announceTimeout&&clearTimeout(this.announceTimeout),this.announceTimeout=window.setTimeout(()=>{const e=this.shadow.querySelector('[role="log"][aria-atomic="true"]');if(e&&this.messages.length>0){const t=this.messages[this.messages.length-1];e.textContent=`${t.type==="user"?"You":"EVA"}: ${t.content}`}},500))}render(){const e=this.getAttr("title-key","chat.title"),t=this.getAttr("placeholder-key","chat.placeholder"),i=this.t(e),n=this.t(t);this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
    ...
    `));const r=document.createElement("div");r.className="chat-panel";const a=document.createElement("div");a.className="chat-header",a.textContent=i,r.appendChild(a),this.messageContainer=document.createElement("div"),this.messageContainer.className="chat-messages",this.messageContainer.setAttribute("role","log"),this.messageContainer.setAttribute("aria-live","polite"),this.messageContainer.setAttribute("aria-atomic","false"),r.appendChild(this.messageContainer);const d=document.createElement("div");d.className="sr-only",d.setAttribute("role","log"),d.setAttribute("aria-live","polite"),d.setAttribute("aria-atomic","true"),r.appendChild(d);const u=document.createElement("form");u.className="chat-form",this.inputField=document.createElement("input"),this.inputField.type="text",this.inputField.className="chat-input",this.inputField.placeholder=n,this.inputField.setAttribute("aria-label",n),u.appendChild(this.inputField);const h=document.createElement("eva-gc-button");h.setAttribute("variant","default"),h.setAttribute("type","submit"),h.textContent=this.t("chat.send"),u.appendChild(h),r.appendChild(u),this.shadow.appendChild(r),this.renderMessages()}}customElements.define("eva-chat-panel",mt);class gt extends c{static get observedAttributes(){return["type","timestamp"]}attributeChangedCallback(){this.render()}render(){const e=this.getAttr("type","user"),t=this.getAttr("timestamp");this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: block;
        margin-bottom: ${o[4]};
      }
    ...
    `));const i=document.createElement("div");i.className=`message ${e}`;const n=document.createElement("div");n.className="message-bubble";const r=document.createElement("slot");if(n.appendChild(r),i.appendChild(n),t){const a=document.createElement("div");a.className="message-meta";const d=new Date(t);a.textContent=d.toLocaleTimeString(),i.appendChild(a)}this.shadow.appendChild(i)}}customElements.define("eva-chat-message",gt);class bt extends c{static get observedAttributes(){return["title-key","description-key","icon","link"]}attributeChangedCallback(){this.render()}render(){const e=this.getAttr("title-key"),t=this.getAttr("description-key"),i=this.getAttr("icon","📄"),n=this.getAttr("link","#"),r=this.t(e),a=this.t(t);this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: block;
        height: 100%;
      }
    ...
    `));const d=document.createElement("a");d.className="card",d.href=n;const u=document.createElement("span");u.className="icon",u.textContent=i,u.setAttribute("aria-hidden","true"),d.appendChild(u);const h=document.createElement("h3");h.className="title",h.textContent=r,d.appendChild(h);const p=document.createElement("p");p.className="description",p.textContent=a,d.appendChild(p),this.shadow.appendChild(d)}}customElements.define("eva-program-card",bt);E.loadLocale("en-CA").then(()=>{E.loadLocale("fr-CA")});document.getElementById("theme-selector").addEventListener("change",l=>{const e=l.target.value;console.log("🎨 Applying theme:",e),document.querySelectorAll("eva-gc-header, eva-gc-footer, eva-gc-button").forEach(t=>{t.setAttribute("profile",e)}),console.log("✅ Theme applied to all GC components")});document.addEventListener("locale-change",async l=>{const e=l.detail.locale;console.log("🌐 Language changed:",e),document.querySelectorAll("[data-i18n]").forEach(t=>{var n;const i=t.getAttribute("data-i18n");i&&(t.textContent=((n=window.i18n)==null?void 0:n.t(i))||t.textContent)}),console.log("✅ Language applied")});document.querySelectorAll("eva-pagination").forEach(l=>{l.addEventListener("change",e=>{console.log("📄 Page changed:",e.detail.page),l.setAttribute("current-page",e.detail.page)})});const M=document.getElementById("demo-slider"),O=document.getElementById("slider-value");M&&O&&M.addEventListener("input",l=>{O.textContent=l.detail.value});const C=document.querySelector('eva-progress[value="60"]');if(C){const l=document.createElement("button");l.className="theme-selector",l.textContent="▶ Animate Progress",l.style.marginTop="8px",l.onclick=()=>{l.disabled=!0,l.textContent="⏳ Animating...";let e=0;const t=setInterval(()=>{C.setAttribute("value",e),e+=5,e>100&&(clearInterval(t),setTimeout(()=>{C.setAttribute("value","60"),l.disabled=!1,l.textContent="▶ Animate Progress"},1e3))},100)},C.parentElement.insertBefore(l,C.nextSibling)}document.querySelectorAll("eva-toggle").forEach(l=>{const e=document.createElement("p");e.style.cssText="margin-top: 8px; color: #666; font-size: 14px;",e.textContent="Status: Not pressed",l.parentElement.insertBefore(e,l.nextSibling),l.addEventListener("toggle",t=>{e.textContent=`Status: ${t.detail.pressed?"Pressed ✓":"Not pressed"}`,e.style.color=t.detail.pressed?"#2b8a3e":"#666"})});document.querySelectorAll("eva-accordion").forEach(l=>{l.addEventListener("accordion-toggle",e=>{console.log("🎵 Accordion toggled:",e.detail)})});document.querySelectorAll("eva-program-card").forEach(l=>{l.style.cursor="pointer",l.addEventListener("click",()=>{console.log("📋 Card clicked:",l.getAttribute("title-key"))})});document.querySelectorAll("[data-code-tabs]").forEach(l=>{const e=l.parentElement;if(!e)return;const t=l.querySelector('[data-target="wc"]'),i=l.querySelector('[data-target="react"]'),n=e.querySelector('[data-pane="wc"]'),r=e.querySelector('[data-pane="react"]'),a=d=>{!t||!i||!n||!r||(d==="wc"?(t.classList.add("active"),i.classList.remove("active"),n.classList.remove("hidden"),r.classList.add("hidden")):(i.classList.add("active"),t.classList.remove("active"),r.classList.remove("hidden"),n.classList.add("hidden")))};t==null||t.addEventListener("click",()=>a("wc")),i==null||i.addEventListener("click",()=>a("react"))});class ft{constructor(e){if(this.current="en-CA",this.store={},e)for(const t of e)this.store[t.path]={"en-CA":{...t.en,locale:"en-CA"},"fr-CA":{...t.fr,locale:"fr-CA"}}}getLocale(){return this.current}setLocale(e){this.current=e;try{localStorage.setItem("eva:locale",e)}catch{}}buildUrl(e,t=this.current){const i=e.startsWith("/")?e.slice(1):e;return`/${(t.split("-")[0]||"en").toLowerCase()}/${i}`}parseLocaleFromUrl(e){const t=e.match(/^\/(en|fr|es|cy|mi)\//);if(!t)return null;const i=t[1];return{en:"en-CA",fr:"fr-CA",es:"es-US",cy:"cy-GB",mi:"mi-NZ"}[i]??"en-CA"}async fetchContent(e,t=this.current){const i=this.store[e];if(i)return i[t==="fr-CA"?"fr-CA":"en-CA"];const r=`/content/${(t.split("-")[0]||"en").toLowerCase()}/${e}.json`,a=await fetch(r);if(!a.ok)throw new Error(`CMS content not found: ${r}`);return{...await a.json(),locale:t}}}function vt(l){try{const t=localStorage.getItem("eva:locale");t&&l.setLocale(t)}catch{}const e=l.parseLocaleFromUrl(window.location.pathname);return e&&l.setLocale(e),l}const yt=[{path:"welcome",en:{id:"welcome",locale:"en-CA",title:"Welcome",body:"Hello from EVA Sovereign UI!"},fr:{id:"bienvenue",locale:"fr-CA",title:"Bienvenue",body:"Bonjour de EVA Sovereign UI!"}},{path:"service/apply",en:{id:"apply",locale:"en-CA",title:"Apply for Service",body:"Complete the application form."},fr:{id:"demande",locale:"fr-CA",title:"Demander le service",body:"Remplissez le formulaire de demande."}}],$=vt(new ft(yt));async function wt(l){const e=await $.fetchContent(l),t=document.getElementById("cms-root");t.innerHTML=`
    <eva-gc-page>
      <header slot="header">
        <nav>
          <a href="${$.buildUrl("welcome")}">Home</a>
          <a href="${$.buildUrl("service/apply")}">Service</a>
  ...
  `}function xt(){const l=window.location.pathname.match(/^\/(en|fr)\/(.*)$/);return l?l[2]:"welcome"}wt(xt());
