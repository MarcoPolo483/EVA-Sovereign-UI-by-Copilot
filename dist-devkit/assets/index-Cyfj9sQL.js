...
`);const C={canada_gc:{id:"canada_gc",name:"Government of Canada",nameFr:"Gouvernement du Canada",colors:{primary:"#26374A",secondary:"#284162",accent:"#A62A1E",text:"#333"},assets:{wordmark:"/assets/canada-wordmark.svg",logo:"/assets/canada-logo.svg",flag:"/assets/canada-flag.svg"},footer:{copyright:"© His Majesty the King in Right of Canada",links:[{label:"Privacy",url:"https://canada.ca/en/transparency/privacy"},{label:"Terms and conditions",url:"https://canada.ca/en/transparency/terms"},{label:"Accessibility",url:"https://canada.ca/en/accessibility"},{label:"Canada.ca",url:"https://canada.ca"}]},locale:{primary:"en-CA",secondary:"fr-CA"}},usa_gov:{id:"usa_gov",name:"U.S. Government",colors:{primary:"#002868",secondary:"#BF0A30",accent:"#FFFFFF",text:"#1b1b1b"},assets:{logo:"/assets/usa-seal.svg",flag:"/assets/usa-flag.svg",seal:"/assets/usa-seal.svg"},footer:{copyright:"An official website of the United States government",links:[{label:"Privacy Policy",url:"https://www.usa.gov/privacy"},{label:"Accessibility",url:"https://www.usa.gov/accessibility"},{label:"USA.gov",url:"https://www.usa.gov"}]},locale:{primary:"en-US"}},uk_gov:{id:"uk_gov",name:"UK Government",colors:{primary:"#012169",secondary:"#C8102E",accent:"#FFFFFF",text:"#0b0c0c"},assets:{logo:"/assets/uk-crown.svg",flag:"/assets/uk-flag.svg"},footer:{copyright:"© Crown copyright",links:[{label:"Privacy",url:"https://www.gov.uk/help/privacy-notice"},{label:"Cookies",url:"https://www.gov.uk/help/cookies"},{label:"Accessibility",url:"https://www.gov.uk/help/accessibility-statement"},{label:"GOV.UK",url:"https://www.gov.uk"}]},locale:{primary:"en-GB"}},australia_gov:{id:"australia_gov",name:"Australian Government",colors:{primary:"#00008B",secondary:"#FFCD00",accent:"#FF0000",text:"#313131"},assets:{logo:"/assets/australia-coat-of-arms.svg",flag:"/assets/australia-flag.svg"},footer:{copyright:"© Commonwealth of Australia",links:[{label:"Privacy",url:"https://www.australia.gov.au/privacy"},{label:"Accessibility",url:"https://www.australia.gov.au/accessibility"},{label:"Australia.gov.au",url:"https://www.australia.gov.au"}]},locale:{primary:"en-AU"}},nz_gov:{id:"nz_gov",name:"New Zealand Government",colors:{primary:"#00247D",secondary:"#CC142B",accent:"#FFFFFF",text:"#212121"},assets:{logo:"/assets/nz-fern.svg",flag:"/assets/nz-flag.svg"},footer:{copyright:"© New Zealand Government",links:[{label:"Privacy",url:"https://www.govt.nz/privacy"},{label:"Accessibility",url:"https://www.govt.nz/accessibility"},{label:"Govt.nz",url:"https://www.govt.nz"}]},locale:{primary:"en-NZ"}}};function k(c){return C[c]||C.canada_gc}class v{constructor(){this.currentLocale="en-CA",this.translations={},this.listeners=new Set}static getInstance(){return v.instance||(v.instance=new v),v.instance}async loadLocale(e){if(!this.translations[e])try{const a=await(await fetch(`/src/i18n/locales/${e}.json`)).json();this.translations[e]=a}catch(t){console.error(`Failed to load locale ${e}:`,t),this.translations[e]={}}}async setLocale(e){this.translations[e]||await this.loadLocale(e),this.currentLocale=e,this.notifyListeners()}getLocale(){return this.currentLocale}t(e,t){const a=e.split(".");let o=this.translations[this.currentLocale];for(const r of a)if(o&&typeof o=="object")o=o[r];else return e;return typeof o!="string"?e:t?o.replace(/\{(\w+)\}/g,(r,i)=>t[i]!==void 0?String(t[i]):`{${i}}`):o}subscribe(e){return this.listeners.add(e),()=>this.listeners.delete(e)}notifyListeners(){this.listeners.forEach(e=>e(this.currentLocale))}getAvailableLocales(){return["en-CA","fr-CA","en-US","es-US","en-GB","cy-GB","en-AU","en-NZ","mi-NZ"]}isLocaleLoaded(e){return!!this.translations[e]}}const w=v.getInstance();class b extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){this.unsubscribeI18n=w.subscribe(()=>{this.render()}),this.render()}disconnectedCallback(){this.unsubscribeI18n&&this.unsubscribeI18n()}render(){}t(e,t){return w.t(e,t)}getAttr(e,t=""){return this.getAttribute(e)||t}getBoolAttr(e){return this.hasAttribute(e)}createStyles(e){const t=document.createElement("style");return t.textContent=e,t}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}}class F extends b{static get observedAttributes(){return["profile","app-name-key","logo-url","flag-url"]}attributeChangedCallback(){this.render()}render(){const e=k(this.getAttr("profile","canada_gc")),t=this.getAttr("app-name-key","esdc.title"),a=this.t(t);this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
    ...
    `));const o=document.createElement("div");o.className="header-container",o.setAttribute("role","banner");const r=document.createElement("div");r.className="logo-section";const i=this.getAttr("logo-url")||e.assets.wordmark||e.assets.logo;if(i){const h=document.createElement("img");h.src=i,h.alt=e.name,h.className="wordmark",r.appendChild(h)}else{const h=document.createElement("div");h.className="logo-placeholder",h.textContent="GC",h.setAttribute("aria-hidden","true"),r.appendChild(h)}const l=this.getAttr("flag-url")||e.assets.flag;if(l){const h=document.createElement("img");h.src=l,h.alt=`${e.name} flag`,h.className="flag",r.appendChild(h)}const d=document.createElement("h1");d.className="app-title",d.textContent=a,r.appendChild(d),o.appendChild(r);const m=document.createElement("nav");m.className="actions-section",m.setAttribute("aria-label",this.t("header.navigation")||"Header navigation");const p=document.createElement("slot");p.name="actions",m.appendChild(p),o.appendChild(m),this.shadow.appendChild(o)}}customElements.define("eva-gc-header",F);class S extends b{static get observedAttributes(){return["profile"]}attributeChangedCallback(){this.render()}render(){const e=k(this.getAttr("profile","canada_gc"));this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: block;
        background: ${n.primary};
        color: ${n.primaryForeground};
    ...
    `));const t=document.createElement("div");t.className="footer-container",t.setAttribute("role","contentinfo");const a=document.createElement("p");a.className="copyright",a.textContent=e.footer.copyright,t.appendChild(a);const o=document.createElement("nav");o.setAttribute("aria-label","Footer navigation");const r=document.createElement("ul");r.className="links",e.footer.links.forEach(i=>{const l=document.createElement("li"),d=document.createElement("a");d.href=i.url,d.textContent=this.t(`footer.${i.label.toLowerCase().replace(/\s+/g,"")}`)||i.label,l.appendChild(d),r.appendChild(l)}),o.appendChild(r),t.appendChild(o),this.shadow.appendChild(t)}}customElements.define("eva-gc-footer",S);class N extends b{static get observedAttributes(){return["variant","size","disabled","loading","aria-label"]}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","presentation"),super.connectedCallback()}attributeChangedCallback(){this.render()}render(){const e=this.getAttr("variant","default"),t=this.getAttr("size","default"),a=this.getBoolAttr("disabled"),o=this.getBoolAttr("loading");this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
    ...
    `));const r=document.createElement("button");r.className=`${e} size-${t}`,r.disabled=a||o,r.setAttribute("type","button"),r.setAttribute("aria-disabled",a||o?"true":"false"),r.setAttribute("aria-busy",o?"true":"false");const i=this.getAttr("aria-label");if(i)r.setAttribute("aria-label",i),this.removeAttribute("aria-label");else{const p=(this.textContent||"").trim().length>0;t==="icon"&&!p&&r.setAttribute("aria-label",this.t("common.button"))}if(o){const p=document.createElement("span");p.className="spinner",p.setAttribute("role","status"),p.setAttribute("aria-label",this.t("accessibility.loading")),r.appendChild(p)}const l=document.createElement("slot");r.appendChild(l);const d=document.createElement("span"),m=()=>{const h=l.assignedNodes({flatten:!0}).map(A=>A.textContent||"").join("").trim();d.textContent=h};m(),l.addEventListener("slotchange",m),r.appendChild(d),this.shadow.appendChild(r)}}customElements.define("eva-gc-button",N);class z extends b{render(){this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: flex;
        flex-direction: column;
        min-height: 100vh;
    ...
    `));const e=document.createElement("header"),t=document.createElement("slot");t.name="header",e.appendChild(t),this.shadow.appendChild(e);const a=document.createElement("main");a.id="main-content",a.setAttribute("role","main"),a.setAttribute("tabindex","-1");const o=document.createElement("slot");a.appendChild(o),this.shadow.appendChild(a);const r=document.createElement("footer"),i=document.createElement("slot");i.name="footer",r.appendChild(i),this.shadow.appendChild(r)}}customElements.define("eva-page-shell",z);class I extends b{static get observedAttributes(){return["title-key","description-key","background"]}attributeChangedCallback(){this.render()}render(){const e=this.getAttr("title-key","esdc.hero.title"),t=this.getAttr("description-key","esdc.hero.description"),a=this.getAttr("background",n.primary),o=this.t(e),r=this.t(t);this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: block;
        background: ${a};
    ...
    `));const i=document.createElement("div");i.className="hero-container";const l=document.createElement("h1");l.className="hero-title",l.textContent=o,i.appendChild(l);const d=document.createElement("p");d.className="hero-description",d.textContent=r,i.appendChild(d),this.shadow.appendChild(i)}}customElements.define("eva-hero-banner",I);class B extends b{static get observedAttributes(){return["max-width"]}attributeChangedCallback(){this.render()}render(){const e=this.getAttr("max-width",E.contentMaxWidth);this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: block;
        width: 100%;
      }
    ...
    `));const t=document.createElement("div");t.className="container";const a=document.createElement("slot");t.appendChild(a),this.shadow.appendChild(t)}}customElements.define("eva-container",B);class P extends b{static get observedAttributes(){return["target"]}connectedCallback(){super.connectedCallback(),this.setupEventListener()}setupEventListener(){this.shadow.addEventListener("click",e=>{e.preventDefault();const t=this.getAttr("target","#main-content"),a=document.querySelector(t)||document.querySelector("main")||this.getRootNode()&&this.getRootNode().querySelector(t);a&&(a.focus(),a.scrollIntoView())})}render(){const e=this.getAttr("target","#main-content");this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: block;
      }
...
• Benefits programs`}renderMessages(){if(!this.messageContainer)return;this.messageContainer.innerHTML="",this.messages.forEach(t=>{const a=document.createElement("eva-chat-message");a.setAttribute("type",t.type),a.setAttribute("timestamp",t.timestamp.toISOString()),a.textContent=t.content,this.messageContainer.appendChild(a)}),this.messageContainer.scrollTop=this.messageContainer.scrollHeight;const e=this.shadow.querySelector('[role="log"]');if(e&&this.messages.length>0){const t=this.messages[this.messages.length-1];e.textContent=`${t.type==="user"?"You":"EVA"}: ${t.content}`}}render(){const e=this.getAttr("title-key","chat.title"),t=this.getAttr("placeholder-key","chat.placeholder"),a=this.t(e),o=this.t(t);this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
    ...
    `));const r=document.createElement("div");r.className="chat-panel";const i=document.createElement("div");i.className="chat-header",i.textContent=a,r.appendChild(i),this.messageContainer=document.createElement("div"),this.messageContainer.className="chat-messages",this.messageContainer.setAttribute("role","log"),this.messageContainer.setAttribute("aria-live","polite"),this.messageContainer.setAttribute("aria-atomic","false"),r.appendChild(this.messageContainer);const l=document.createElement("div");l.className="sr-only",l.setAttribute("role","log"),l.setAttribute("aria-live","polite"),l.setAttribute("aria-atomic","true"),r.appendChild(l);const d=document.createElement("form");d.className="chat-form",this.inputField=document.createElement("input"),this.inputField.type="text",this.inputField.className="chat-input",this.inputField.placeholder=o,this.inputField.setAttribute("aria-label",o),d.appendChild(this.inputField);const m=document.createElement("eva-gc-button");m.setAttribute("variant","default"),m.setAttribute("type","submit"),m.textContent=this.t("chat.send"),d.appendChild(m),r.appendChild(d),this.shadow.appendChild(r),this.renderMessages()}}customElements.define("eva-chat-panel",T);class H extends b{static get observedAttributes(){return["type","timestamp"]}attributeChangedCallback(){this.render()}render(){const e=this.getAttr("type","user"),t=this.getAttr("timestamp");this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: block;
        margin-bottom: ${s[4]};
      }
    ...
    `));const a=document.createElement("div");a.className=`message ${e}`;const o=document.createElement("div");o.className="message-bubble";const r=document.createElement("slot");if(o.appendChild(r),a.appendChild(o),t){const i=document.createElement("div");i.className="message-meta";const l=new Date(t);i.textContent=l.toLocaleTimeString(),a.appendChild(i)}this.shadow.appendChild(a)}}customElements.define("eva-chat-message",H);class U extends b{static get observedAttributes(){return["title-key","description-key","icon","link"]}attributeChangedCallback(){this.render()}render(){const e=this.getAttr("title-key"),t=this.getAttr("description-key"),a=this.getAttr("icon","📄"),o=this.getAttr("link","#"),r=this.t(e),i=this.t(t);this.shadow.innerHTML="",this.shadow.appendChild(this.createStyles(`
      :host {
        display: block;
        height: 100%;
      }
    ...
    `));const l=document.createElement("a");l.className="card",l.href=o;const d=document.createElement("span");d.className="icon",d.textContent=a,d.setAttribute("aria-hidden","true"),l.appendChild(d);const m=document.createElement("h3");m.className="title",m.textContent=r,l.appendChild(m);const p=document.createElement("p");p.className="description",p.textContent=i,l.appendChild(p),this.shadow.appendChild(l)}}customElements.define("eva-program-card",U);w.loadLocale("en-CA").then(()=>{w.loadLocale("fr-CA")});document.getElementById("theme-selector").addEventListener("change",c=>{const e=c.target.value;document.querySelectorAll("eva-gc-header, eva-gc-footer").forEach(t=>{t.setAttribute("profile",e)})});document.querySelectorAll("[data-code-tabs]").forEach(c=>{const e=c.parentElement;if(!e)return;const t=c.querySelector('[data-target="wc"]'),a=c.querySelector('[data-target="react"]'),o=e.querySelector('[data-pane="wc"]'),r=e.querySelector('[data-pane="react"]'),i=l=>{!t||!a||!o||!r||(l==="wc"?(t.classList.add("active"),a.classList.remove("active"),o.classList.remove("hidden"),r.classList.add("hidden")):(a.classList.add("active"),t.classList.remove("active"),r.classList.remove("hidden"),o.classList.add("hidden")))};t==null||t.addEventListener("click",()=>i("wc")),a==null||a.addEventListener("click",()=>i("react"))});class O{constructor(e){if(this.current="en-CA",this.store={},e)for(const t of e)this.store[t.path]={"en-CA":{...t.en,locale:"en-CA"},"fr-CA":{...t.fr,locale:"fr-CA"}}}getLocale(){return this.current}setLocale(e){this.current=e;try{localStorage.setItem("eva:locale",e)}catch{}}buildUrl(e,t=this.current){const a=e.startsWith("/")?e.slice(1):e;return`/${(t.split("-")[0]||"en").toLowerCase()}/${a}`}parseLocaleFromUrl(e){const t=e.match(/^\/(en|fr|es|cy|mi)\//);if(!t)return null;const a=t[1];return{en:"en-CA",fr:"fr-CA",es:"es-US",cy:"cy-GB",mi:"mi-NZ"}[a]??"en-CA"}async fetchContent(e,t=this.current){const a=this.store[e];if(a)return a[t==="fr-CA"?"fr-CA":"en-CA"];const r=`/content/${(t.split("-")[0]||"en").toLowerCase()}/${e}.json`,i=await fetch(r);if(!i.ok)throw new Error(`CMS content not found: ${r}`);return{...await i.json(),locale:t}}}function G(c){try{const t=localStorage.getItem("eva:locale");t&&c.setLocale(t)}catch{}const e=c.parseLocaleFromUrl(window.location.pathname);return e&&c.setLocale(e),c}const V=[{path:"welcome",en:{id:"welcome",locale:"en-CA",title:"Welcome",body:"Hello from EVA Sovereign UI!"},fr:{id:"bienvenue",locale:"fr-CA",title:"Bienvenue",body:"Bonjour de EVA Sovereign UI!"}},{path:"service/apply",en:{id:"apply",locale:"en-CA",title:"Apply for Service",body:"Complete the application form."},fr:{id:"demande",locale:"fr-CA",title:"Demander le service",body:"Remplissez le formulaire de demande."}}],$=G(new O(V));async function j(c){const e=await $.fetchContent(c),t=document.getElementById("cms-root");t.innerHTML=`
    <eva-gc-page>
      <header slot="header">
        <nav>
  ...
  `}function R(){const c=window.location.pathname.match(/^\/(en|fr)\/(.*)$/);return c?c[2]:"welcome"}j(R());
