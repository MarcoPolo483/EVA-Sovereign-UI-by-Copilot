...
// Inuktitut support - placeholder for future implementation
// import iuCA from './locales/iu-CA.json';

// Canada-only: English and French (official languages)
i18nService.setTranslations('en-CA', enCA);
i18nService.setTranslations('fr-CA', frCA);
// i18nService.setTranslations('iu-CA', iuCA); // Future: Indigenous language support
