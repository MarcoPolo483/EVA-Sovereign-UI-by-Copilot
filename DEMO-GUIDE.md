...
## Demo 3: World-Class Demo Gallery (8–12 minutes)

**URL**: http://localhost:5173/demos/index.html

### Pages & Quick Links
- All-in-One Gallery: `/demos/all-in-one.html`
- Overview & Kitchen Sink: `/demos/overview.html`
- Foundations & Theming: `/demos/foundations-theming.html`
- Navigation & Shell: `/demos/navigation-shell.html`
- Forms & Validation: `/demos/forms-validation.html`
- Feedback & Overlays: `/demos/feedback-overlays.html`
- Content & Data Display: `/demos/content-data.html`
- Files, Media & Data Viz: `/demos/files-media-viz.html`
...
- Cards, tags, tables (columns/data binding), timeline items
- File upload (accept/size), chart with accessible tabular data, responsive media
- Locale coverage: en-CA, fr-CA, en-US, es-US, en-GB, cy-GB, en-AU, en-NZ, mi-NZ
- CMS static fallback loaders for EN/FR content exemplars

**Why This Matters**: End-to-end, production-grade patterns with accessible ARIA, keyboard-first behavior, and internationalization—ready to copy, adapt, and deploy.
